package com.nopcommerce.framework.utils.report;

import com.nopcommerce.framework.utils.file.FileManager;
import com.nopcommerce.framework.utils.OSUtils;
import com.nopcommerce.framework.utils.TerminalUtils;
...
import static com.nopcommerce.framework.utils.dataReader.PropertyReader.getProperty;
import static com.nopcommerce.framework.utils.report.AllureConstants.HISTORY_FOLDER;
import static com.nopcommerce.framework.utils.report.AllureConstants.RESULTS_HISTORY_FOLDER;
...
public class AllureReportGenerator {
    ...
    public static String renameReport() {
        ...
        FileManager.renameFile(AllureConstants.REPORT_PATH.resolve(AllureConstants.INDEX_HTML).toString(), newFileName);
        return newFileName;
    }
